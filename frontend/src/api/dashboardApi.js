...
export const fetchCombinedTotals = async () => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/combined/stats/total`, { timeout: API_TIMEOUT_MS });
...
export const fetchCombinedMonthlyDownloads = async (month) => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/combined/downloads`, { params: { month }, timeout: API_TIMEOUT_MS });
...
export const fetchCombinedDownloadsRange = async (from, to) => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/combined/downloads/range`, { params: { from, to }, timeout: API_TIMEOUT_MS });
...
export const fetchIosDownloadsDaily = async (date) => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/ios/downloads/daily`, { params: { date }, timeout: API_TIMEOUT_MS });
...
export const fetchIosDownloadsMonthly = async (month) => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/ios/downloads/monthly`, { params: { month }, timeout: API_TIMEOUT_MS });
    return response.data;
  } catch (error) {
...
export const fetchIosDownloadsRange = async (from, to) => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/ios/downloads/range`, { params: { from, to }, timeout: API_TIMEOUT_MS });
    return response.data;
  } catch (error) {
...
export const fetchAndroidDownloadsMonthly = async (month) => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/android/downloads`, { params: { month }, timeout: API_TIMEOUT_MS });
    return response.data;
  } catch (error) {
...
export const fetchAndroidDownloadsRange = async (from, to) => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/android/downloads/range`, { params: { from, to }, timeout: API_TIMEOUT_MS });
    return response.data;
  } catch (error) {
...
export const fetchAndroidRatings = async (month) => {
  try {
    const response = await axios.get(`${DL_TRACKER_BASE_URL}/android/ratings`, { params: { month }, timeout: API_TIMEOUT_MS });
    return response.data;
  } catch (error) {
...
export const fetchActiveUsers = async () => {
  try {
    const response = await axios.get(ACTIVE_USERS_ENDPOINT, { timeout: API_TIMEOUT_MS });
...
export const fetchTotalDids = async () => {
  try {
    const response = await axios.get(TOTAL_DIDS_ENDPOINT, { timeout: API_TIMEOUT_MS });
